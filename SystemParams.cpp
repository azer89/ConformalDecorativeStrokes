...
std::string SystemParams::kite_texture_file        = "../ConformalDecorativeStrokes/decorative_strokes/23-01_kite.png";
std::string SystemParams::leg_texture_file         = "../ConformalDecorativeStrokes/decorative_strokes/23-01_leg.png";
std::string SystemParams::rectilinear_texture_file = "../ConformalDecorativeStrokes/decorative_strokes/23-01_straight.png";
